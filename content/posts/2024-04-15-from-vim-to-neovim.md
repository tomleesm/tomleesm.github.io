...
date: 2024-04-15T20:34:09+08:00
toc: false
authors:
  - Tom
lightgallery: true
...
![nvim-flexoki.png](/images/nvim-flexoki.png)
對比原來 Vim 的配色更好看。
![vim-wombat256mod.png](/images/vim-wombat256mod.png)
也有可能是原來的配色幾年下來已經看膩了。
...
# 編輯 ~/.bash_profile，加上 Neovim 檔案路徑
vim ~/.bash_profile
...
1. 在 host 端，連到 [https://www.nerdfonts.com/font-downloads](https://www.nerdfonts.com/font-downloads) ，搜尋 Source Code Pro，點選 SauceCodePro Nerd Font
2. 解壓縮後，滑鼠點兩下打開 SauceCodeProNerdFont-Regular.ttf 檔案，按右上方按鈕 install
3. 設定終端機使用這個字型
...
![neovim-screenshot.png](/images/neovim-screenshot.png)